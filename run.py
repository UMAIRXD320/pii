    ...
    if SAKERA != 159403:
        ...
        try:
            ...
            if len(na) < 2:
                nd = na[0].lower()
                if len(nd)<3:pass
                elif len(nd)==3 or len(nd)==4 or len(nd)==5:listpass.append(nd+"123");listpass.append(nd+"12");listpass.append(nd+"1");listpass.append(nd+"1234");listpass.append(nd+"786");listpass.append(nd+"12345")
